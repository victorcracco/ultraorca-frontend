...
export default function SupportButton() {
  // M1 FIX: Número em variável de ambiente (configure VITE_SUPPORT_WHATSAPP no .env.local e na Vercel)
  const whatsappNumber = import.meta.env.VITE_SUPPORT_WHATSAPP || "5514998469800";
