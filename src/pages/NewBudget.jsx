                ...
                <div className="space-y-3">
                  ...
                  {publicLink && (
                    <div className="bg-purple-50 border border-purple-200 rounded-xl p-3 space-y-2">
                      ...
                      <button
                        onClick={() => {
                          const text = `Olá, ${client}! Segue o link do seu orçamento para análise:\n${publicLink}\n\nPelo link você pode aceitar ou recusar a proposta.`;
                          window.open(`https://api.whatsapp.com/send?text=${encodeURIComponent(text)}`, "_blank");
                        }}
                        className="w-full flex items-center justify-center gap-2 py-2 rounded-lg bg-green-500 hover:bg-green-600 text-white text-xs font-bold transition"
                      >
