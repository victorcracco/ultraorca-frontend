              ...
              <>
                ...
                <div className="space-y-3">
                  ...
                  <button
                    ...
                    className={`w-full py-3 px-6 rounded-xl font-semibold text-purple-600 border border-purple-200 hover:bg-purple-50 flex justify-center items-center gap-2 transition active:scale-95 ${loadingLink ? "opacity-60 cursor-not-allowed" : ""}`}
                  >
                    {loadingLink ? (
                      <div className="animate-spin h-5 w-5 border-b-2 border-purple-600 rounded-full" />
                    ) : (
                      <>
