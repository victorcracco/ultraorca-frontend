                ...
                {accepted ? (
                  ...
                  <div className="space-y-3">
                    <button
                      ...
                      className="w-full py-3 px-6 rounded-xl font-bold text-white flex items-center justify-center gap-2 transition active:scale-[0.98] shadow-md"
                    ...
                    <button
                      ...
                      disabled={accepting || rejecting}
                      className="w-full py-2 text-sm text-red-400 hover:text-red-600 transition text-center"
                    >
